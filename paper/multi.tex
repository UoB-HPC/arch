...
\begin{table}[h]
  \begin{center}
    \begin{tabular}{ccccc}
      \hline
      \textbf{Device} & \textbf{Hot (s)} & \textbf{Flow (s)} & \textbf{Hot'n'Flow (s)} & \textbf{Difference (s)} \\
      \hline
